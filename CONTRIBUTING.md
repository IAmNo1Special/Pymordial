# Contributing to Pymordial

Thank you for your interest in contributing to Pymordial! This document provides guidelines for contributing.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Pymordial.git
   cd Pymordial
   ```
